...
<<<<<<< HEAD   (893ef2 Fix critical CVEs in pti-o2imsdms image)
...
# Resolve entrypoint path for pg:18+
...
>>>>>>> CHANGE (2b357f Upgrade postgres to 18 and replace redis with valkey)
