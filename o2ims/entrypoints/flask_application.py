...
def configure_routes(app, bus):
    ...
    @app.route(apibase + "/resourceTypes", methods=["POST", "PUT", "PATCH", "DELETE"])
    ...
    @app.route(apibase + "/resourceTypes/<resourceTypeID>", methods=["POST", "PUT", "PATCH", "DELETE"])
    ...
    @app.route(apibase + "/resourcePools", methods=["POST", "PUT", "PATCH", "DELETE"])
    ...
    @app.route(apibase + "/resourcePools/<resourcePoolID>", methods=["POST", "PUT", "PATCH", "DELETE"])
    def resource_pools_one_not_allow(resourcePoolID):
        return "Method Not Allowed", 405


    ############## Resources ##############
    @app.route(apibase + "/resourcePools/<resourcePoolID>/resources", methods=["GET"])
    def resources(resourcePoolID):
        result = ocloud_view.resources(resourcePoolID, bus.uow)
        return jsonify(result), 200

    @app.route(apibase + "/resourcePools/<resourcePoolID>/resources", methods=["POST", "PUT", "PATCH", "DELETE"])
    def resource_not_allow(resourcePoolID):
        return "Method Not Allowed", 405


    @app.route(apibase + "/resourcePools/<resourcePoolID>/resources/<resourceID>", methods=["GET"])
    ...
    @app.route(apibase + "/resourcePools/<resourcePoolID>/resources/<resourceID>", methods=["POST", "PUT", "PATCH", "DELETE"])
    ...
    @app.route(apibase + "/deploymentManagers", methods=["POST", "PUT", "PATCH", "DELETE"])
    def deployment_managers_not_allow():
        return "Method Not Allowed", 405


    @app.route(apibase + "/deploymentManagers/<deploymentManagerID>", methods=["GET"])
    def deployment_manager_one(deploymentManagerID):
        result = ocloud_view.deployment_manager_one(deploymentManagerID, bus.uow)
        if result is None:
            return "", 200
        return jsonify(result), 200

    @app.route(apibase + "/deploymentManagers/<deploymentManagerID>", methods=["POST", "PUT", "PATCH", "DELETE"])
