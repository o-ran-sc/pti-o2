    ...
    def _prune_stale_dms(self, ocloudid):
        ...
        try:
            with self._bus.uow as uow:
                ...
                #current_ids = set(getattr(d, 'deploymentManagerId', getattr(d, 'id', None)) for d in current_dms)
                ...
                if hasattr(uow, 'deployment_managers'):
                    ...
                    db_dms = db_dms.all()
                    #db_ids = set(getattr(d, 'deploymentManagerId', getattr(d, 'id', None)) for d in db_dms)
