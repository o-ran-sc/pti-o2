...
from o2ims.views.performance_dto import PerformanceDTO
...
@api_monitoring_v1.route("/v1/measurementJobs")
...
class MeasurementJobListRouter(Resource):
    ...
    @api_monitoring_v1.doc('Get Measurement Job List')
...
@api_monitoring_v1.route("/v1/measurementJobs/<measurementJobId>")
@api_monitoring_v1.param('measurementJobId', 'ID of the measurement job')
@api_monitoring_v1.response(404, 'Measurement Job not found')
class MeasurementJobGetRouter(Resource):
    model = PerformanceDTO.measurement_job_get

    @api_monitoring_v1.doc('Get Measurement Job Information')
