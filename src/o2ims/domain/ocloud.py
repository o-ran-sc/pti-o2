...
class Ocloud:
    def __init__(
        self, ocloudid: str, name: str, imsendpoint: str,
    ...
    def addDeploymentManager(self, deploymentManager: DeploymentManager) -> None:
        deploymentManager.oCloudId = self.oCloudId
        old = filter(
            lambda x: x.deploymentManagerId == deploymentManager.deploymentManagerId,
            self.deploymentManagers)
        for o in old or []:
...
class DeploymentManager:
    def __init__(self, id: str, name: str, ocloudid: str, dmsendpoint: str) -> None:
...
class ResourcePool:
    def __init__(self, id: str, name: str, location: str, ocloudid: str) -> None:
...
class ResourceType:
    def __init__(self, typeid: str, name:str, typeEnum: ResourceTypeEnum, ocloudid: str) -> None:
...
class Resource:
    def __init__(self, resourceId:str, resourceTypeId: str, resourcePoolId: str) -> None:
