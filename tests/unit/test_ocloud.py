...
from tests.conftest import sqlite_uow, sqlite_flask_uow
...
def test_new_resource_type():
    ...
    resource_type1 = ocloud.ResourceType(resource_type_id1, "resourcetype1", rt.ResourceTypeEnum.PSERVER, ocloud1.oCloudId)
    assert resource_type_id1 is not None and resource_type1.resourceTypeId == resource_type_id1

def test_new_resource_pool():
    ocloud1 = setup_ocloud()
    resource_pool_id1 = str(uuid.uuid4())
    resource_pool1 = ocloud.ResourcePool(resource_pool_id1, "resourcepool1", config.get_api_url(), ocloud1.oCloudId)
    assert resource_pool_id1 is not None and resource_pool1.resourcePoolId == resource_pool_id1

def test_new_resource():
    resource_id1 = str(uuid.uuid4())
    resource_type_id1 = str(uuid.uuid4())
    resource_pool_id1 = str(uuid.uuid4())
    resource1 = ocloud.Resource(resource_id1, resource_type_id1, resource_pool_id1)
...
def test_view_resource_types(sqlite_uow):
    ...
    assert str(resource_type_list[0].get("resourceTypeId")) == resource_type_id1
...
def test_view_resource_type_one(sqlite_uow):
    ...
    # Query return None
    resource_type_res = ocloud_view.resource_type_one(resource_type_id1, sqlite_uow)
...
def test_view_resource_pools(sqlite_uow):
    ...
    assert str(resource_pool_list[0].get("resourcePoolId")) == resource_pool_id1
...
def test_view_resource_pool_one(sqlite_uow):
    ...
    # Query return None
    resource_pool_res = ocloud_view.resource_pool_one(resource_pool_id1, sqlite_uow)
